...
if test -e /etc/libvirt/hooks/qemu.d/win10/prepare/begin/cpu_mode_performance.sh && test -e /etc/libvirt/hooks/qemu.d/win10/prepare/begin/cpu_pinning.sh; then
...
if test -e /etc/libvirt/hooks/qemu.d/win10/release/end/cpu_mode_ondemand.sh && test -e /etc/libvirt/hooks/qemu.d/win10/release/end/cpu_unpinning.sh; then
